...
import { ServicesPerformanceReport } from "@/components/reports/services-performance-report";
...
export default function RelatoriosPage() {
  ...
  // ... (maintain all existing data preparation logic above)
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gold">Relatórios Administrativos</h1>
          <p className="text-muted-foreground">
            Visão geral financeira e de operações
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="financial" className="space-y-6">
        <TabsList className="bg-secondary/50 p-1 rounded-lg">
          <TabsTrigger value="financial" className="px-6 data-[state=active]:bg-gold data-[state=active]:text-black">
            Financeiro
          </TabsTrigger>
          <TabsTrigger value="services" className="px-6 data-[state=active]:bg-gold data-[state=active]:text-black">
        ...
        <TabsContent value="financial" className="space-y-6">
          <div className="flex items-center justify-end">
            <div className="w-48">
              <Label className="mb-2 block text-xs">Período de Análise</Label>
